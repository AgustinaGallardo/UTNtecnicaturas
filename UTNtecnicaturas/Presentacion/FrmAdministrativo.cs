...
using UTNtecnicaturas.Presentacion.Reporte10;
...
namespace UTNtecnicaturas.Presentacion
{
    public partial class FrmAdministrativo : Form
    {
        ...
        private void extranjerosDeProgrmacionPromediosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmReporte10 frmReport10 = new frmReporte10();
            frmReport10.ShowDialog();
            this.Show();
        }
    }
}
